package fredy.josue.dougbe.repository;

import fredy.josue.dougbe.DougbeApp;
import fredy.josue.dougbe.config.Constants;
import fredy.josue.dougbe.config.audit.AuditEventConverter;
import fredy.josue.dougbe.domain.PersistentAuditEvent;
...
import static fredy.josue.dougbe.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
